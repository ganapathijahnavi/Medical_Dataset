...
Recommendation: Weight management; reduce processed foods.
...
Recommendation: Stop alcohol immediately; seek urgent care.
...
Output: Normal, but diabetes increases NAFLD risk,
Recommendation: Monitor liver enzymes yearly.

Case 8
Input: ALT = 120 IU/L (male, 40 years old, on statins),
Output: Elevated; possible drug-induced liver injury,
...
Recommendation: Continue prescribed immunosuppressive therapy.
...
Recommendation: Discontinue supplements; recheck levels.
...
Recommendation: Antiviral therapy; hepatology care.
...
Output: Severely elevated; due to reduced liver blood flow,
Recommendation: Treat underlying cardiac condition.
